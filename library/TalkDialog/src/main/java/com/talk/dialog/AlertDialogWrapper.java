...
public class AlertDialogWrapper {
    ...
    public static class Builder {
        ...
        private final TalkDialog.Builder builder;
        ...
        public Builder setAdapter(ListAdapter adapter, final DialogInterface.OnClickListener listener) {
            ...
            builder.listCallbackCustom = new TalkDialog.ListCallback() {
                @Override
        ...
        private void addListCallbacks() {
            if (onClickListener != null) {
                builder.itemsCallback(new TalkDialog.ListCallback() {
                    @Override
                    public void onSelection(TalkDialog dialog, View itemView, int which, CharSequence text) {
        ...
        private void addButtonsCallback() {
            if (positiveDialogListener != null || negativeDialogListener != null) {
                builder.callback(new TalkDialog.ButtonCallback() {
                    @Override
                    ...
                    @Override
                    public void onPositive(TalkDialog dialog, View view) {
        ...
        private void setUpMultiChoiceCallback(@Nullable final boolean[] checkedItems, final DialogInterface.OnMultiChoiceClickListener listener) {
            ...
            builder.itemsCallbackMultiChoice(selectedIndicesArr, new TalkDialog.ListCallbackMultiChoice() {
                @Override
                public boolean onSelection(TalkDialog dialog, Integer[] which, CharSequence[] text) {
