...
import com.talk.dialog.TalkDialog.Builder;
import com.talk.dialog.TalkDialog.ButtonCallback;
...
public class MaterialEditTextPreference extends EditTextPreference {
    ...
    protected void showDialog(Bundle state) {
        Builder mBuilder = new TalkDialog.Builder(getContext())
    ...
    /**
     * Callback listener for the TalkDialog. Positive button checks with
