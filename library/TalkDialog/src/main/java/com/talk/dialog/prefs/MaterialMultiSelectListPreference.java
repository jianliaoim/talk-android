...
public class MaterialMultiSelectListPreference extends MultiSelectListPreference {
    ...
    protected void showDialog(Bundle state) {
        ...
        TalkDialog.Builder builder = new TalkDialog.Builder(context)
                ...
                .items(getEntries())
                .itemsCallbackMultiChoice(indices.toArray(new Integer[indices.size()]), new TalkDialog.ListCallbackMultiChoice() {
                    @Override
