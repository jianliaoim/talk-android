...
//    private boolean mFullscreenEnabled = false;
    ...
    private void init(Context context) {
        ...
        View viewRoot = inflater.inflate(R.layout.media_controller, this);
    ...
    public void reset() {
        ...
        mTurnButton.setImageResource(R.drawable.ic_player_player_btn);
    ...
    private OnClickListener mCenterPlayListener = new OnClickListener() {
        public void onClick(View v) {
            hideCenterView();
            reset();
            ((IjkVideoView) mPlayer).togglePlayer();
            mPlayer.start();
        }
    };
    ...
    private void updatePausePlay() {
        if (mPlayer != null && mPlayer.isPlaying()) {
            mTurnButton.setImageResource(R.drawable.ic_stop_btn);
        } else {
            mTurnButton.setImageResource(R.drawable.ic_player_player_btn);
        }
    }
    ...
    void updateScaleButton() {
        if (mIsFullScreen) {
            mScaleButton.setImageResource(R.drawable.ic_star_zoom_in);
        } else {
            mScaleButton.setImageResource(R.drawable.ic_player_scale_btn);
        }
    }
